...
def start_cubys():
    sp.Popen(["python", "Cubys_Final.py"])
def start_flappybird():
    sp.Popen(["python", "flappybird.py"])
def start_pong():
    sp.Popen(["python", "pong.py"])


try:
    contents=open("CreatedFile/player_name.txt",'r+')
except FileNotFoundError:
    contents=open("CreatedFile/player_name.txt",'w')
    contents.write("New Player")
    contents.close() 
content=open("CreatedFile/player_name.txt",'r+')
...
cubys_logo=Image.open("Media/Icons/CubysLogo.png")
...
pong_logo=Image.open("Media/Icons/pong.png")
...
flappy_logo=Image.open("Media/Icons/flappybird.png")
...
player_icon=tk.PhotoImage(file='Media/Icons/p2.png')
...
edit_icon=tk.PhotoImage(file='Media/Icons/edit.png')
edit_icon=edit_icon.subsample(5,5)

save_icon=tk.PhotoImage(file='Media/Icons/save.png')
...
def change_name():
    ...
    if IS_LABEL==True:
      ...
      content=open("CreatedFile/player_name.txt",'w')
