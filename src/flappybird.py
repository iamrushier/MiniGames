...
# load images
bg = pygame.image.load('assets/Sprites/Flappy/bg.png')
ground_img = pygame.image.load('assets/Sprites/Flappy/Extra/ground1.png.png')
button_img = pygame.image.load('assets/Sprites/Flappy/restart (1).png')
...
class Bird(pygame.sprite.Sprite):  # Here we are using sprite class
    def __init__(self, x, y):
        ...
        for num in range(1, 4):  # range b/w 1-4 i.e. 3 as we've 3 images
            img = pygame.image.load(f'assets/Sprites/Flappy/bird{num}.png')  # f stands for format of the string as we want
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, position):
        ...
        self.image = pygame.image.load('assets/Sprites/Flappy/pipe (1).png')
