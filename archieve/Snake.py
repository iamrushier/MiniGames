...
#image=tk.PhotoImage(file="CubysLogo.png").subsample(3)
title_font=tkfont.Font(family='HP Simplified Hans',size=65,weight='bold')
lable1=tk.Label(title_frame,bg='black')
...
try:
    contents=open("CreatedFile/cubys_highscore.txt",'r+')
except FileNotFoundError:
    contents=open("CreatedFile/cubys_highscore.txt",'w')
...
contents.close()
os.remove('CreatedFile/cubys_highscore.txt')
contents=open("CreatedFile/cubys_highscore.txt",'w')
